...
public class CallRecord {
    ...
    public static class Builder {
        ...
        public Builder(Context context) {
            ...
            PrefsHelper.writePrefInt(mContext, PREF_AUDIO_SOURCE, MediaRecorder.AudioSource.VOICE_COMMUNICATION);//VOICE_COMMUNICATION
            PrefsHelper.writePrefInt(mContext, PREF_AUDIO_ENCODER, MediaRecorder.AudioEncoder.DEFAULT);
            PrefsHelper.writePrefInt(mContext, PREF_OUTPUT_FORMAT, MediaRecorder.OutputFormat.AMR_NB); //todo  yua AMR_NB
